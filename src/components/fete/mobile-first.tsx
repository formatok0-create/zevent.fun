      ...
      <div className="shell">
        ...
        <div className="mt-16 grid gap-14 lg:grid-cols-12 lg:gap-20">
          <Reveal className="lg:col-span-6">
            <p className="eyebrow text-flamme">Pensé pour le pouce</p>
            <h2 className="mt-8 font-fete font-bold tracking-[-0.02em] text-[clamp(2.2rem,5vw,3.5rem)] leading-[1.05]">
              Le lien sera ouvert
              <br />
              <span className="italic">dans un groupe WhatsApp.</span>
            </h2>
          ...
          <Reveal delay={0.12} className="lg:col-span-6 lg:pt-4">
            <ul className="space-y-5 border-t border-line pt-8 lg:border-t-0 lg:pt-0">
              {[
                ...
                "Compte à rebours et playlist sans application",
              ].map((line) => (
                <li key={line} className="flex items-start gap-4 text-sm font-light text-ink-soft">
                  <span aria-hidden className="mt-2.5 h-px w-6 shrink-0 bg-flamme" />
                  {line}
                </li>
              ))}
            </ul>
